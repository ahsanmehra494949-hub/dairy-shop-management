...
export default function DeleteConfirmModal({ open, onClose, onConfirm, productName, title = 'Delete product?', message }) {
  return (
    <AnimatePresence>
      {open && (
        <motion.div
        ...
        >
          ...
          >
            ...
            <h3 className="text-lg font-display font-semibold text-ink-900 mb-1.5">{title}</h3>
